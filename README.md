...
This framework also includes a [Trainer class](https://github.com/luiserrador/ml/blob/master/utils/kd.py) to apply Knowledge Distilation on segmentation problems that use 3D-Unet, by following this approach:
<p align="center">
